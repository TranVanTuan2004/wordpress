<?php
/**
 * Template Name: Suất Chiếu Đặc Biệt
 */
get_header(); 
?>

<div class="container" style="padding: 40px 20px;">
    <h1 style="text-align: center; margin-bottom: 40px; color: #fff;">SUẤT CHIẾU ĐẶC BIỆT</h1>
    
    <div class="movie-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 30px;">
        <?php
        // Query phim suất chiếu đặc biệt theo meta field
        $args = array(
            'post_type' => 'mbs_movie',
            'posts_per_page' => -1,
            'post_status' => 'publish',
        ...
        ?>
            <p style="color: #fff; text-align: center; grid-column: 1 / -1;">Hiện chưa có suất chiếu đặc biệt nào.</p>
        <?php endif; ?>
    </div>
</div>
